  ...
  return (<BaseSimulatorPageContainer>
    ...
    <BaseSimulatorPageBody>
      <div className="max-w-4xl mx-auto">
        ...
        <Paragraph>
          Please note there are other things which may impact what a user can or cannot do. For example, if a user A and user B both have the Administrator permission, they are still unable to take certain actions against the server owner, such as mute and kick. They will also be unable to take certain actions against other administrator's whose highest ranking role is higher than their own in the role hierarchy.
        </Paragraph>
        ...
        <UnorderedList>
          ...
          <ListItem>
            If a role provides the Administrator permission, then a user will have ALL permissions.
          </ListItem>
          <ListItem>
